...
We rely on Github Actions `windows-2022` plus a few extra utilities as per [the workflow](https://github.com/seventwos-app/usr-workspace-desktop/blob/develop/.github/workflows/build_desktop_windows.yaml).
