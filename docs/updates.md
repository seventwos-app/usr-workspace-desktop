...
Currently all packaging & deployment is handled by [Github actions](https://github.com/seventwos-app/usr-workspace-desktop/blob/develop/.github/workflows/build_desktop_and_deploy.yaml)
